...
const NotiIcon = () => {
  return (
    <svg
      ...
      fill="none"
      role="img"
      aria-labelledby="anubx1pe46sytjo5gi92z92alnau5vjj"
      className="devto-icon crayons-icon--default"
    >
      <title id="anubx1pe46sytjo5gi92z92alnau5vjj">Notifications</title>
      <path
